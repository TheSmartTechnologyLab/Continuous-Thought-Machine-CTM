...
def train_loop(model, trainloader, testloader, device, iterations=2000, test_every=100, lr=1e-4, checkpoint_dir=None, hf_repo=None, hf_token=None, resume=False, args=None):
    ...
    if resume and checkpoint_dir is not None:
        ...
        if ck:
            ...
            # advance data iterator to next batch (best effort)
            try:
                for _ in range(start_iteration % len(trainloader)):
